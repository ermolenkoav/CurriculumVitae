...
\href{https://t.me/ermolenkoav}{Telegram} \\ % Email
...
\bluebullet Golang & \bluebullet SQL & \bluebullet C/C++ \\
\bluebullet Java & \bluebullet Python \\
\end{tabular}}

\CVItem{Computer Software}
{\begin{tabular}{p{0.2\textwidth} p{0.2\textwidth} p{0.2\textwidth}}
\bluebullet Linux & \bluebullet Docker Compose & \bluebullet K8s \\
\bluebullet CI/CD \\
\end{tabular}}
...
\begin{itemize}
	\item Replaced the NATS cluster with the Kafka cluster of all department services
	\item Development of integration services 
	\begin{itemize}
		\item Golang - fasthttp,pgx,franz-go,clickhouse-go e.t.c
	\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item \LaTeX{}, \href{Diagrams.net}{Draw.io}, 
	\end{itemize}
\end{itemize}
}
...
\CVItem{English}{B2 Intermediate}
\Sep % Extra whitespace after the end of a section
